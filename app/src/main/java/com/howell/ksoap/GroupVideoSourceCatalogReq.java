 ...
 * @author 霍之昊 
 *
 * 类说明:查询视频源分组下的视频源列表 request
 */
public class GroupVideoSourceCatalogReq {
	private String session;
	private String internetDeviceId;
	private String id;
	private int pageIndex;
	private int pageSize;
	public GroupVideoSourceCatalogReq(String session, String internetDeviceId,
	...
	public GroupVideoSourceCatalogReq() {
		super();
	}
