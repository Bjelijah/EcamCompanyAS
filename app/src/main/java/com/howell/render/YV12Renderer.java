...
//		YV12Renderer.time = time;
	...
	public YV12Renderer(Context context, GLSurfaceView view ,DetectIfHasFrameUtils hasFrameUtils) {
		context_ = context;
		gl_surface_view_ = view;
		this.hasFrameUtils = hasFrameUtils;
//		frames = 0.000f;
		nativeInit();
	}
...
//Draw |textures| using |vertices| (X,Y coordinates).
	...
	public void onSurfaceChanged(GL10 gl, int width, int height) {
		...
		Log.e("123","on surface changed "+width+" "+height);
		if (height>width) {
