...
JNIEXPORT void JNICALL Java_com_howell_render_YV12Renderer_nativeInit
...
JNIEXPORT void JNICALL Java_com_howell_render_YV12Renderer_nativeOnSurfaceCreated
(JNIEnv *env, jobject obj)
{
  //self.inited=1;
  self.enable=1;
...
JNIEXPORT void JNICALL Java_com_howell_render_YV12Renderer_nativeRenderY
(JNIEnv *env, jobject obj)
{
	LOGE("nativeRenderY");
...
JNIEXPORT void JNICALL Java_com_howell_render_YV12Renderer_nativeRenderU
(JNIEnv *env, jobject obj)
{
	LOGE("nativeRenderU");
	if(self.lock_ret != 0){
...
JNIEXPORT void JNICALL Java_com_howell_render_YV12Renderer_nativeRenderV
(JNIEnv *env, jobject obj)
{
	if(self.lock_ret != 0){
		  return;
...
JNIEXPORT void JNICALL Java_com_howell_render_YV12Renderer_nativeDeinit
(JNIEnv *env, jobject obj)
{
  /* TODO */
	LOGE("nativeDeinit1");
